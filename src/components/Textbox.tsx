...
export default function Textbox({placeholder, canHighlight, border, onChange, id, 
	setBorderColor}: 
	...
	return (
		...
		onChange={onChange} rows={1} id={id}
		className={`p-2.5 w-full h-14 truncate text-gray-900 bg-gray-50 rounded-lg 
		${border} text-xl
